...
namespace DataversePlugin
{
	...
	/// </summary>
	public class HtmlDocumentQueryPlugin : PluginBase
	{
		public HtmlDocumentQueryPlugin(string unsecureConfiguration, string secureConfiguration)
			: base(typeof(HtmlDocumentQueryPlugin))
		{
